...
function FormUpdate(){
    ...
    const handleData = async() => {
        ...
        if(state) {
        const data = await axios.post("https://instaclone-api-backend.onrender.com/post", postInfo)
        .then((response) => {
        ...
        axios.post("https://instaclone-api-backend.onrender.com/upload", formData)
